...
b3 = Blog.create(user_id: 2, title: "Jewels", genre: "DIY", content: "This is how you make jewelry.")
b4 = Blog.create(user_id: 2, title: "Cooking with a Sous Vide", genre: "Cooking", content: "You stick the sous vide in water. Store your item in a plastic bag and place it in the pot of water. Voila, it's cooked. ")
b5 = Blog.create(user_id: 3, title: "Weddings in July", genre: "Lifestyle", content: "Getting married in Austin in February will be a blast." )
b6 = Blog.create(user_id: 3, title: "San Francisco", genre: "Cities", content: "One of the best cities in the world.")
b7 = Blog.create(user_id: 3, title: "How To Make a Mean Steak", genre: "Cooking", content: "Only good when medium rare.")
b8 = Blog.create(user_id: 4, title: "Salad Recipe", genre: "Cooking", content: "Make salads at home because who loves paying $15 for leaves?")
